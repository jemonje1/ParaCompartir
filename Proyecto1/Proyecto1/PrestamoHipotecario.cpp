...
PrestamoHipotecario::PrestamoHipotecario(int id, string cliente, string banco, string tipo, double cantidad, double cantidadfija, double intereses)
    : Prestamo(id, cliente, banco, tipo, cantidad, cantidadfija, interes){
};
